...
public class Application extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        javax.swing.GroupLayout splitSmartSwapClustererSettingPanelLayout = new javax.swing.GroupLayout(splitSmartSwapClustererSettingPanel);
        splitSmartSwapClustererSettingPanel.setLayout(splitSmartSwapClustererSettingPanelLayout);
        splitSmartSwapClustererSettingPanelLayout.setHorizontalGroup(
        ...
        splitSmartSwapClustererSettingPanelLayout.setVerticalGroup(
            splitSmartSwapClustererSettingPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        splitSmartSwapClustererSelectPanel.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                splitSmartSwapClustererSelectPanelMouseReleased(evt);
            }
        });

        jLabel28.setText("SplitSmartSwapClusterer");

        splitSmartSwapClustererRadio.setSelected(true);
        splitSmartSwapClustererRadio.setPreferredSize(new java.awt.Dimension(28, 28));
        splitSmartSwapClustererRadio.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                splitSmartSwapClustererRadioStateChanged(evt);
            }
        });

        javax.swing.GroupLayout splitSmartSwapClustererSelectPanelLayout = new javax.swing.GroupLayout(splitSmartSwapClustererSelectPanel);
        splitSmartSwapClustererSelectPanel.setLayout(splitSmartSwapClustererSelectPanelLayout);
        splitSmartSwapClustererSelectPanelLayout.setHorizontalGroup(
            splitSmartSwapClustererSelectPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        splitSmartSwapClustererSelectPanelLayout.setVerticalGroup(
            splitSmartSwapClustererSelectPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(splitSmartSwapClustererSelectPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(splitSmartSwapClustererSelectPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(splitSmartSwapClustererRadio, javax.swing.GroupLayout.PREFERRED_SIZE, 0, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel28))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        javax.swing.GroupLayout splitSmartSwapClustererPanelLayout = new javax.swing.GroupLayout(splitSmartSwapClustererPanel);
        splitSmartSwapClustererPanel.setLayout(splitSmartSwapClustererPanelLayout);
        splitSmartSwapClustererPanelLayout.setHorizontalGroup(
            splitSmartSwapClustererPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(splitSmartSwapClustererSettingPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addComponent(splitSmartSwapClustererSelectPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        splitSmartSwapClustererPanelLayout.setVerticalGroup(
            splitSmartSwapClustererPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, splitSmartSwapClustererPanelLayout.createSequentialGroup()
                .addComponent(splitSmartSwapClustererSelectPanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(splitSmartSwapClustererSettingPanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
                ...
                .addGroup(settingPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, settingPanelLayout.createSequentialGroup()
                        .addGroup(settingPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(trajectoryClusterPanel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void hierarchicalSelectPanelMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_hierarchicalSelectPanelMouseReleased
	    ...
	    splitSmartSwapClustererSettingPanel.setVisible(selected);
            if (selected) {
                splitSmartSwapClustererPanel.setBorder(BorderFactory.createLoweredBevelBorder());
            } else {
                splitSmartSwapClustererPanel.setBorder(BorderFactory.createRaisedBevelBorder());
            }
        }//GEN-LAST:event_splitSmartSwapClustererRadioStateChanged

        private void splitSmartSwapClustererSelectPanelMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_splitSmartSwapClustererSelectPanelMouseReleased
            splitSmartSwapClustererRadio.setSelected(!splitSmartSwapClustererRadio.isSelected());
        }//GEN-LAST:event_splitSmartSwapClustererSelectPanelMouseReleased

    private void trajectoryClusterRadioStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_trajectoryClusterRadioStateChanged
        // TODO add your handling code here:
        boolean selected = trajectoryClusterRadio.isSelected();
	    trajectoryClusterSettingPanel.setVisible(selected);
            if (selected) {
                trajectoryClusterPanel.setBorder(BorderFactory.createLoweredBevelBorder());
            } else {
                trajectoryClusterPanel.setBorder(BorderFactory.createRaisedBevelBorder());
            }
    }//GEN-LAST:event_trajectoryClusterRadioStateChanged

    private void trajectoryClusterSelectPanelMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_trajectoryClusterSelectPanelMouseReleased
        // TODO add your handling code here:
    ...
    private javax.swing.JPanel trajectoryClusterSettingPanel;
